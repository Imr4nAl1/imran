...
def MRIMRAN(OK,cp):
    if len(OK) != 0 or len(cp) != 0:
        ...
        print('----------------------------------------------')
        print(' [%s+%s] \033[1;92m SUCCESSFULL : %s --- \033[1;97m/sdcard/SOLO-OK.txt'%(O,O,str(len(ok))))
        print(' [%s+%s] \033[1;92m CHECKPOINTS : %s --- \033[1;97m/sdcard/SOLO-CP.txt'%(O,O,str(len(cp))))
        print('----------------------------------------------')
...
def python_java():
    ...
    print(" \033[1;92m              BEGGARS CANT BE CHOOSERS")
    print(" \033[1;97m ---------------------------------------------");time.sleep(0.03)
